!(function (t, e) {
				...
				polyfill: function () {
					...
					function f(t) {
						...
						(n = o = 1 < o ? 1 : o),
							...
							(i === t.x && s === t.y) ||
								a.requestAnimationFrame(f.bind(a, t));
					}
					function r(t, e, i) {
						var s,
							n,
				...
				return (
					...
					o(i, [
						...
						},
						{
							...
							value: function () {
								var t = this;
								u(r(i.prototype), "checkScroll", this).call(
									this
								),
								...
								if ("string" == typeof t) {
									if ("top" === t) l = this.html;
										...
										l =
											...
											window.innerHeight;
									else if (!(l = document.querySelector(t)))
										return;
	...
	var E = k,
		...
		O = {
			...
			hasTouchWin:
				navigator.msMaxTouchPoints && 1 < navigator.msMaxTouchPoints,
	...
	var J = function (o, e, l, i) {
			...
			if (o === e && l === i) return G;
			for (
				var r = q ? new Float32Array(11) : new Array(11), t = 0;
				t < 11;
				++t
			)
				r[t] = U(0.1 * t, o, l);
						...
						value: function () {
							...
							if (
								...
								for (
									...
									(this.instance.scroll.y >
										this.sections[i].offset &&
										this.instance.scroll.y <
											this.sections[i].limit)
										? (this.transform(
												this.sections[i].el,
												0,
												-this.instance.scroll.y
						...
						value: function (t, e) {
							...
							var d = parseFloat(this.instance.delta.y),
								f =
									Math.max(
										0,
										Math.min(a, this.instance.limit)
									) - d,
								p = function (t) {
									l
										? s.setScroll(
