...
---------------------------------------------------*/
	...
	window.ScrollEffects = function() {
		...
		// Filippi Panic Button
		$('#panic_button').on('click', function() {	
			let filippiheight1 = document.querySelector('#main').offsetHeight,
				filippiheight2 = document.querySelector('footer').offsetHeight,
				filippiheight3 = document.querySelector('#contatti').offsetHeight,
				filippiheight4 = filippiheight1 + filippiheight2 + filippiheight3;

			if ($("body").hasClass("smooth-scroll")) {
				gsap.to(scrollbar, {duration: 1.5, scrollTop:filippiheight4, ease:Power4.easeInOut});
				gsap.to('#ball', {duration: 0.3, borderWidth: '4px', scale:0.5, borderColor:'#999999', delay:0.15});
			} else {
				gsap.to(scrollbar, {duration: 1.5, scrollTop:filippiheight4, ease:Power4.easeInOut});
				gsap.to('#ball', {duration: 0.3,  borderWidth: '4px', scale:0.5, borderColor:'#999999', delay:0.15});
